...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private  RadioRealButton online;
    private  RadioRealButton offline ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.email);
         online =  (RadioRealButton) findViewById(R.id.online);
        offline =   (RadioRealButton) findViewById(R.id.offline);
        group =   (RadioRealButtonGroup) findViewById(R.id.mode_group);
...
// onClickButton listener detects any click performed on buttons by touch
        group.setOnClickedButtonListener(new RadioRealButtonGroup.OnClickedButtonListener() {
            ...
            public void onClickedButton(RadioRealButton button, int position) {
                if(position == ONLINE)
                {
                    Store.getInstance().mode = "ONLINE";
                }
                else
                {
                    Store.getInstance().mode = "OFFLINE";
                }
                Toast.makeText(LoginActivity.this, "MODE: " +  Store.getInstance().mode , Toast.LENGTH_SHORT).show();
            }
        });
...
// return false if you want to detect long click and change position when you release
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password,Context context) {
            mEmail = email;
            mPassword = password;
            this.url = "user/mobileLogin";;
            this.params.put("username",this.mEmail);
            this.params.put("password",this.mPassword);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if(jsonStr!=null) {
                ...
                if (!jsonStr.contains("failure")) {


                    Store.getInstance().user.setUsername(this.mEmail);
                    Store.getInstance().user.setRole(jsonStr);
